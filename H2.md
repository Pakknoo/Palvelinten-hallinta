...
Komennolla `sudo salt-call --local -l info state.single file.managed /tmp/esimerkkitiedosto` kokeilin luoda tiedoston /tmp kansioon: 

Komento suoritettiin onnistuneesti ja tyhjä tekstitiedosto luotiin /tmp-kansioon. Kävin vielä tarkistamassa, että tiedosto on todella olemassa.

![Screenshot](https://github.com/user-attachments/assets/8c6281f5-d23b-4ed8-abc4-74242eabedd6)

![Screenshot](https://github.com/user-attachments/assets/fc38fd9a-4f21-4e53-ae5d-96586c11c8ed)

# f) Aja esimerkki sls-tiedostosi verkon yli orjalla.

Aluksi loin esimerkki-kansion /srv/salt/esimerkki komennolla `sudo mkdir -p /srv/salt/esimerkki/`
...
Tämän jälkeen ajoin herralla komennon sudo salt '*' state.apply esimerkki

![Screenshot](https://github.com/user-attachments/assets/5e488ae3-f01f-4eaf-89a1-11daf42de0ad)

Komento loi orja-tietokoneelle esimerkkitiedoston kansioon /tmp. Kävin vielä tarkistamassa, että tiedosto oli varmasti luotu.

![Screenshot](https://github.com/user-attachments/assets/bb593d45-47a0-4a2c-b729-d8f7c316df18)

...
![Screenshot](https://github.com/user-attachments/assets/a0725024-f1e1-4b12-bca1-37907821c991)

Ajoin tiedoston paikallisesti komennolla `sudo salt-call --local state.apply komennot`

Sain kuitenkin allaolevan ilmoituksen:

![Screenshot](https://github.com/user-attachments/assets/79e71f55-9bf4-4f06-8296-1a8882543f0f)

Vaikuttaa siltä, että käyttäjä pystyttäisiin luomaan, mutta jostain syystä micron asennus ei onnistu. Syy miksi komennon suorittaminen ei onnistu jäi epäselväksi, sillä ilmoituksessa ei kunnolla lue epäonnistumisen syytä, siinä vaan lukee killed. 

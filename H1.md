...
Aloitin saltin asennuksen debianille asentamalla uuden pakettivaraston saltin sivuilla olevien ohjeiden mukaan (VMWare 2024a). Asennuksessa käytin komentoja:
...
luo /tmp -kansioon tiedoston nimeltä foo. Ehtona (creates="/tmp/foo") on, että tiedostoa ei ole vielä olemassa (Karvinen 2021; VMWare 2024b).
...
VMware 2024a. Salt install Debian guide. Luettavissa osoitteessa: https://docs.saltproject.io/salt/install-guide/en/latest/topics/install-by-operating-system/debian.html#install-salt-on-debian-12-bookworm-amd64

VMware 2024b. Salt.states.cmd. Luettavissa osoitteessa:
